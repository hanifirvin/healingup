...
/// Functions to query JurnalRecords (as a Stream and as a Future).
Future<int> queryJurnalRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      JurnalRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<JurnalRecord>> queryJurnalRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      JurnalRecord.collection,
      JurnalRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<JurnalRecord>> queryJurnalRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query KesslerRecords (as a Stream and as a Future).
Future<int> queryKesslerRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
...
Stream<List<KesslerRecord>> queryKesslerRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<List<KesslerRecord>> queryKesslerRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
