...
class DokterPageUtamaWidget extends StatefulWidget {
  /// halaman utama untuk dokter yang berisi banyak menu yang hanya dapat
  /// diakses oleh role dokter
  ///
  const DokterPageUtamaWidget({super.key});

  @override
  State<DokterPageUtamaWidget> createState() => _DokterPageUtamaWidgetState();
}

class _DokterPageUtamaWidgetState extends State<DokterPageUtamaWidget> {
  late DokterPageUtamaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DokterPageUtamaModel());
                              ...
                              Row(
                                ...
                                children: [
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      context.pushNamed('daftar_pasien');
                                    },
                                    child: Column(
                                      mainAxisSize: MainAxisSize.min,
                                      crossAxisAlignment:
