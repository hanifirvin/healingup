                    ...
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsetsDirectional.fromSTEB(
                            16.0, 50.0, 16.0, 50.0),
                        child: Text(
                          'Dalam 30 hari terakhir, seberapa sering kamu merasa resah atau gelisah?',
                          style: FlutterFlowTheme.of(context)
                              .headlineSmall
                              .override(
                                fontFamily: 'Poppins',
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          FFAppState().updateQuizAnswer(4, 1);

                                          context.pushNamed('quiz6');
                                        },
                                        text: 'Tidak Pernah',
                                    ...
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          FFAppState().updateQuizAnswer(4, 2);
                                    ...
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          FFAppState().updateQuizAnswer(4, 3);
                                    ...
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          FFAppState().updateQuizAnswer(4, 4);
                                    ...
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          FFAppState().updateQuizAnswer(4, 5);
