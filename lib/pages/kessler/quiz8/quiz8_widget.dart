                    ...
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsetsDirectional.fromSTEB(
                            16.0, 50.0, 16.0, 50.0),
                        child: Text(
                          'Dalam 30 hari terakhir, seberapa sering kamu merasa bahwa segala sesuatu membutuhkan usaha?',
                          style: FlutterFlowTheme.of(context)
                              .headlineSmall
                              .override(
                                fontFamily: 'Poppins',
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          FFAppState().updateQuizAnswer(7, 1);

                                          context.pushNamed('quiz9');
                                        },
                                        text: 'Tidak Pernah',
                                    ...
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          FFAppState().updateQuizAnswer(7, 2);
                                    ...
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          FFAppState().updateQuizAnswer(7, 3);
                                    ...
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          FFAppState().updateQuizAnswer(7, 4);
                                    ...
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          FFAppState().updateQuizAnswer(7, 5);
